...
This application was developed using the React library. The code from the introduction to the React official site (https://reactjs.org/tutorial/tutorial.html) was taken as the basis.
***
